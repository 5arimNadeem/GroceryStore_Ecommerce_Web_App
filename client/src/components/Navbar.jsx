...
const Navbar = () => {
    ...
    const { assets, user, setUser, setShowUserLogin, navigate, setSearchQuery, searchQuery, getCartCount, axios } = useAppContext(AppContext)
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                {!user ? (
                    ...
                    <div className="relative group">
                        ...
                        <ul className="group-hover:block hidden absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40">
