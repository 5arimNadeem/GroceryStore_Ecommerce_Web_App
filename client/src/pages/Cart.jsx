...
const Cart = () => {
    const { navigate, user, assets, products, updateCartItem, removeFromCart, cartItems, currency, getCartAmount, getCartCount, axios, setCartItems } = useAppContext()
